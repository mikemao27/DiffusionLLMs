...
class ModelRunner:
    ...
    def _forward_raw(
        ...
        if forward_batch.forward_mode.is_decode():
            ...
            _t_prefill_start = _time.perf_counter()
            ...
            _torch.cuda.synchronize()
            _t_prefill_end = _time.perf_counter()
            print(f"[PREFILL] num_tokens={forward_batch.input_ids.shape[0]} "
                  f"time={(_t_prefill_end - _t_prefill_start)*1000:.2f}ms")
